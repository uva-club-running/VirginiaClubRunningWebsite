function Practice() {
  return (
    <div id="practice" className="relative w-screen">
      <img
        src="assets/practice_splash.png"
        alt="Banner"
      ...
      <div className="absolute flex flex-col xl:flex-row justify:center xl:justify-start inset-0 items-center xl:items-start">
        <div className="flex-row xl:ml-[2%] mt-5 xl:mt-[5%]">
          ...
          <h1 className="mt-3 text-center text-vaorange-500 text-2xl sm:text-4xl lg:text-4xl xl:text-5xl font-bodoni italic">
            Building character - and muscles.
          </h1>
          <div className="text-center xl: text-start text-sm p-4 rounded mt-5 sm:text-md lg:text-xl xl:text-2xl text-white font-franklin italic">
            <p>
              The club practices Monday through Thursday at Nameless Field, near
              Memorial Gym. Practices are held at 5:00pm during the fall. During
              the spring, practices will be held at 5:00pm on Monday/Thursday,
              and 4:00pm Tuesday/Wednesday. After the clock shifts on March 9th,
              the time for all days will be 5:00pm.
            </p>
            <p className="mt-6">
              No practices are mandatory; some runners attend only a few
              practices a week while many of our runners attend as many as
              possible. Members also frequently organize their own runs on
              weekends, and many track their runs on Strava.
            </p>
          </div>
        </div>
        <div className=" w-full h-full flex justify-center items-center">
          <iframe
            className="widget mb-25 sm:w-100 sm:h-60 lg:h-120 lg:w-70"
            allowTransparency
            frameBorder="0"
            scrolling="no"
