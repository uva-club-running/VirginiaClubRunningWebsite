        ...
        <div className="relative w-screen">
            ...
            <div className="absolute inset-0 flex items-start justify-center">
                <div className="flex-row mt-16">
                    <h1 className="text-white text-9xl font-bold font-franklin bg-opacity-50 top-4">
                        Club Running
                    </h1>
                    <h1 className="mt-3 text-center text-vaorange-500 text-9xl font-bodoni italic">at UVA</h1>
                </div>
                <div
                    onClick={() => {
