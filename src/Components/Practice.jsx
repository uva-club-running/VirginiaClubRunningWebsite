    ...
    return (
        <div id="practice" className="relative w-screen">
            ...
            <div className="absolute flex justify-start inset-0 items-start">
                <div className="flex-row mt-30 ml-80">
                    <h1 className="text-center text-white text-7xl font-bold font-franklin bg-opacity-50 top-4">
                        Practices.
                    </h1>
                    <h1 className="mt-3 text-center text-vaorange-500 text-5xl font-bodoni italic">Building character -
                        and muscles.</h1>
                    <div className="w-230 p-4 rounded mt-5">
                        <p className="text-white text-2xl font-franklin italic">The club practices Monday through
                            Thursday at
                        ...
                        <p className="mt-6 text-white text-2xl font-franklin italic">No practices are mandatory; some
